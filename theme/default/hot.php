...
<head>
  ...
  <title><?php echo $hot_title; ?> - <?php echo $config['title']; ?></title>
  ...
  <style>
    .root-color {
      color: <?php echo $colors[date("w")] ?>;
    }

    .root-background {
      background-color: <?php echo $colors[date("w")] ?>;
    }
  </style>
</head>
      ...
      <div class="lylmepage relative left-[50%] -translate-x-[50%]">
        <div id="lylme" class="root-background">
          <header font="song bold" text="center white" pb-2="">
            ...
            <h2 text-5xl="" py-3=""><a href="../"><?php echo $hot_title; ?></a></h2>
            ...
            <div my-3="">
              ...
              if (!empty($hots)) {
                foreach ($hots as $item) {
                  echo '<a name="' . $item["alias"] . '"><h1 class="root-color"  font="song bold" mb-3=""><i>「' . $item["name"] . '」</i></h1>  </a>
                      <ul text-sm="">';
